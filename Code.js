function doPost(e) {
  ...
  if (typeof e !== 'undefined') {
    ...
    var coupon_object_new_purchase_price = coupon_object.new_purchase_price;
    var coupon_object_number_available = coupon_object.number_available;
    var coupon_object_code = coupon_object.code;
    var coupon_object_name = coupon_object.name;
    var coupon_object_expiration = coupon_object.expiration_date;
    var coupon_object_uses = coupon_object.number_of_uses;

    // affiliate level
    var affiliate_object = event_object.affiliate;
    var affiliate_object_id = affiliate_object.id;
    var affiliate_object_email = affiliate_object.email;
    var affiliate_object_name = affiliate_object.name;

    // transactions level
    var transactions_object = event_object.transactions[0];
    var transactions_object_final_price = transactions_object.final_price;
    var transactions_object_affiliate_percent = transactions_object.affiliate_percent;
    var transactions_object_affiliate_fees = transactions_object.affiliate_fees;
    var transactions_object_teachable_percent = transactions_object.teachable_percent;
    var transactions_object_teachable_processor_fee = transactions_object.teachable_processor_fee;
    var transactions_object_teachable_fixed_fee = transactions_object.teachable_fixed_fee;
    var transactions_object_total_teachable_fee = transactions_object.total_teachable_fee;
    var transactions_object_net_charge = transactions_object.net_charge;
    var transactions_object_earnings_usd = transactions_object.earnings_usd;
    var transactions_object_payment_method = transactions_object.payment_method;
    ...
    sheet.getRange(lastRow + 1,1,1,31).setValues([newRow]);
